    ...
    <div>
      <section className="  container mx-auto text-white lg:px-10 px-4 py-6 flex lg:flex-row flex-col lg:gap-0 gap-6 justify-between">
        <div className="lg:w-[40%] w-full">
          <p className="font-normal text-2xl text-white ">About Us</p>
          <h1 className="font-extrabold text-[32px] leading-[42px] sm:pr-30 mb-10">
            We Provide You{" "}
        ...
        <div className="grid xl:grid-cols-2 grid-cols-1  sm:space-x-32 space-y-10 sm:gap-32 gap-4  ">
          ...
          <div className="space-y-2 text-white">
            <div className=" space-y-5 text-white ">
              <p className="2xl:text-2xl text-xl leading-10 font-normal">
                About Unicorn Tech
              </p>
              <h3 className="2xl:text-[40px] text-3xl leading-12 font-bold">
                Experts in{" "}
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 2xl:gap-x-10 gap-x-2  md:gap-y-5 gap-y-10 mt-20">
              <div className="space-y-5 2xl:pr-20 xl:pr-10 ">
                {" "}
      ...
      <div className="w-[90%] mx-auto">
        <div className="w-full mt-20 grid lg:grid-cols-4 md:grid-cols-2  grid-cols-1 gap-4">
          ...
          <div className="flex justify-between flex-col my-10">
            <h1 className="text-wrap italic font-bold sm:text-[27px] text-xl sm:leading-7 text-white">
              " We don’t just adapt to the future; we shape it with innovation.
              "
            </h1>
            <div className="w-full flex justify-center items-center sm:mt-0 mt-4 gap-5">
              <img src={CEO} alt="" />
        ...
        <div className=" mt-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-8 md:gap-16 2xl:gap-32 text-white">
            ...
            <div className="flex flex-col space-y-4">
              <p className="font-normal text-xl md:text-2xl">Our Expertise</p>
              <h1 className="font-bold text-3xl md:text-[32px]">
                Innovating Across{" "}
              ...
              <div className="w-full sm:w-4/5">
                <button className="flex items-center gap-3 py-1 px-3 border border-[#368DE5] rounded-sm text-[#368DE5] text-base md:text-[16px] mt-8 hover:bg-gradient-to-r hover:from-[#368DE5] hover:to-[#C7BDFF] hover:text-white transition-colors duration-300 ease-in-out">
            ...
            <div className="flex flex-col space-y-8">
              <div className="flex flex-col sm:flex-row justify-between gap-4">
                <div className="flex flex-col items-start">
                  <span className="text-3xl md:text-[40px] text-[#368DE5] font-bold">
                    11
                  </span>
              ...
              <div className="space-y-2">
                <h1 className="text-2xl md:text-3xl font-bold">Advance Tool</h1>
                <p className="text-base font-light">
          ...
          <div className="absolute xl:my-10 xl:mx-20 lg:my-7 lg:mx-14  md:mx-8 md:my-4  m-4 inset-0 text-white bg-[#0B0A72]/50 backdrop-blur-lg rounded-[20px] flex flex-col justify-center items-center">
            <div className=" w-full sm:px-10 px-4 grid lg:grid-cols-4 grid-cols-2 lg:gap-5 gap-2">
              <div className="col-span-2 ">
                <p className="lg:text-2xl text-xl font-normal">Our Features</p>
                <h2 className="lg:text-[42px] text-3xl leading-11 font-bold">
                  What we Offer
                </h2>
              </div>
              <div className="flex border border-[#368DE5] rounded-sm lg:p-5 p-2 items-center sm:gap-4 gap-2 backdrop-blur-lg">
                ...
                <img
                  className="sm:w-auto sm:h-auto w-10 h-10"
                  src={Pen}
                  alt=""
                />
              </div>
        ...
        {/* team members */}
        <div className="w-full space-y-10 text-white my-32">
          <div className=" w-full flex flex-col justify-between items-center gap-y-5">
            <p className="text-2xl font-normal">Our Expert Team Members </p>
            <h4 className="text-[32px] leading-[42px]">
              Strength in <span className="text-[#368DE5]">Skilled Teams</span>.
            </h4>
            <p className="font-light text-base mt-5 text-center w-2xl">
...
const Card = ({ card }) => (
  <div className=" bg-[#001118] rounded-[20px] px-3 py-5 text-white flex flex-col md:items-start  items-center ">
    <img src={card.img} className="w-24 h-24 object-center" />
    <p className="text-2xl font-bold my-5">{card.title}</p>
